...
async function getTrendingStocks() {
    const response = await fetch(`https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=IBM&interval=5min&apikey=${'qVd1leY5IghprcF12oglJUxm_r8dJg5S'}`);
    const data = await response.json();
